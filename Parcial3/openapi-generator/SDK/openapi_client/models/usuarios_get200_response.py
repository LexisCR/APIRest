...
class UsuariosGet200Response(BaseModel):
    """
    UsuariosGet200Response
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, alias="Id")
    nombre: Optional[StrictStr] = Field(default=None, alias="Nombre")
    apellido: Optional[StrictStr] = Field(default=None, alias="Apellido")
    telefono: Optional[StrictStr] = Field(default=None, alias="Telefono")
    __properties: ClassVar[List[str]] = ["Id", "Nombre", "Apellido", "Telefono"]
